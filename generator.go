...
func (g *Generator) Flush(w io.Writer) (err error) {
	...
	g.write("package %s\n\n", g.Pkg.Name)
	g.write("// This file is auto-generated by `tplize`.\n")
	g.write("// `tplize` make contents of non-Go files to Go variable,\n")
	g.write("// so that your binary can use them.\n")
	g.write("// See https://github.com/otiai10/tplize for more information.\n\n")

	g.write("// %s is template pool.\n", g.VarName)
